...
<?php  $mp_token = M('public')->where(array('id'=>I('public_id')))->getField('interface_token'); ?>
...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?> 
    <section id="contents" class="tab-content">
        ...
        <p class="desc">
        以下是你的公众号的配置信息<br>
          你的接口URL是：<span style="color: #FF0000"><?php echo U('home/weixin/index',array('id'=>$_GET['public_id']));?></span><br>
          Token固定是：<span style="color: #F00"><?php echo ($mp_token); ?></span></p>
        </div>
      </div>
